...
<head>
  ...
  <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy meals to as many as people as possible.">
    ...
    <section class="section-step" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="resources/img/app-iPhone.png" alt="omnifood on iPhone" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <a href="#" class="btn-app"><img src="resources/img/download-app.svg" alt="iStore"></a>
                <a href="#" class="btn-app"><img src="resources/img/download-app-android.png" alt="google Play"></a>
            </div>
        </div>
    </section>
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            ...
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <i class="ion-social-twitter icon-small"></i>
                    <a href="#" class=""> @omnifood_berlin</a>
                </div>
            </div> 
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <i class="ion-social-twitter icon-small"></i>
                    <a href="#" class="" >@omnifood_london</a>
                </div>
            </div>
        </div>
    </section>
    <section class="section-testimonials">
        ...
        <div class="col span-1-of-3">
            <blockqoute>
                ...
                <cite> <img src="resources/img/customer-1.jpg">Albert Dungcan</cite>
                </blockquote>
        </div> 
        <div class="col span-1-of-3">
            <blockqoute>
            ...
            <div class="row">
                <form method="POST" action="mailer.php" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col span-2-of-3">
                            <input type="checkbox" name="neweletter" id="news" checked required> Yes, please
                        </div>
                    </div>
                    <div class="row">
                        <div class="col span-1-of-3">
